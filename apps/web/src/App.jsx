...
import { ProtectedRoute, RoleRoute, AdminRoute } from '@/components/ProtectedRoute.jsx';
...
// ── Dashboard Musicien (/musicien/dashboard) ──────────────────────────────────
import ArtistDashboard from '@/pages/ArtistDashboard.jsx';

// ── Pages partagées (profil, paramètres) ─────────────────────────────────────
import ProfilePage from '@/pages/ProfilePage.jsx';
import SettingsPage from '@/pages/SettingsPage.jsx';

// ── Ancienne route /dashboard (redirection automatique par rôle) ─────────────
          ...
          <CartProvider>
            ...
            <Routes>
              ...
              {/* ══════════════════════════════════════════════════════════════
                  ...
                  Rôles autorisés : etudiant (admin a accès via AdminRoute)
              ══════════════════════════════════════════════════════════════ */}
              <Route
                path="/etudiant/dashboard"
                element={<RoleRoute allowedRoles={['etudiant']}><StudentDashboard /></RoleRoute>}
              />
              <Route
                path="/etudiant/dashboard/courses"
                element={<RoleRoute allowedRoles={['etudiant']}><CoursesPage /></RoleRoute>}
              />
              <Route
                path="/etudiant/dashboard/courses/:courseId/view"
              ...
              <Route
                ...
                element={<RoleRoute allowedRoles={['etudiant']}><RecallPage /></RoleRoute>}
              />
              <Route
                path="/etudiant/dashboard/orders"
                element={<RoleRoute allowedRoles={['etudiant']}><OrdersPage /></RoleRoute>}
              />
              <Route
                path="/etudiant/dashboard/profile"
                element={<RoleRoute allowedRoles={['etudiant']}><ProfilePage /></RoleRoute>}
              />
              <Route
                path="/etudiant/dashboard/settings"
                element={<RoleRoute allowedRoles={['etudiant']}><SettingsPage /></RoleRoute>}
              />
              ...
              <Route
                ...
                element={<RoleRoute allowedRoles={['client']}><ClientDashboardPage /></RoleRoute>}
              />
              <Route
                path="/client/dashboard/orders"
                element={<RoleRoute allowedRoles={['client']}><OrdersPage /></RoleRoute>}
              />
              <Route
                path="/client/dashboard/profile"
                element={<RoleRoute allowedRoles={['client']}><ProfilePage /></RoleRoute>}
              />
              <Route
                path="/client/dashboard/settings"
                element={<RoleRoute allowedRoles={['client']}><SettingsPage /></RoleRoute>}
              />

              {/* ══════════════════════════════════════════════════════════════
                  ESPACE MUSICIEN / STUDIO — /musicien/dashboard
                  Rôles autorisés : musicien
              ══════════════════════════════════════════════════════════════ */}
              <Route
                path="/musicien/dashboard"
                element={<RoleRoute allowedRoles={['musicien']}><ArtistDashboard /></RoleRoute>}
              />
              <Route
                path="/musicien/dashboard/profile"
                element={<RoleRoute allowedRoles={['musicien']}><ProfilePage /></RoleRoute>}
              />
              <Route
                path="/musicien/dashboard/settings"
                element={<RoleRoute allowedRoles={['musicien']}><SettingsPage /></RoleRoute>}
              />
              <Route
                path="/musicien/dashboard/orders"
                element={<RoleRoute allowedRoles={['musicien']}><OrdersPage /></RoleRoute>}
              />

              {/* ══════════════════════════════════════════════════════════════
                  ANCIENNE ROUTE /dashboard — Redirection automatique par rôle
                  Garde la compatibilité des anciens liens (emails, bookmarks).
                  ProtectedRoute redirige vers getDashboardPath(role).
              ══════════════════════════════════════════════════════════════ */}
