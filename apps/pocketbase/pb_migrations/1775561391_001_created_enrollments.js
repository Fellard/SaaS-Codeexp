...
migrate((app) => {
  ...
  const pbc_4564003031Collection = app.findCollectionByNameOrId("pbc_4564003031");
  ...
  const collection = new Collection({
    ...
    "fields":     [
          ...
          },
          {
                ...
                "type": "relation",
                "cascadeDelete": false,
                "collectionId": pbc_4564003031Collection.id,
                "displayFields": [],
                "maxSelect": 1,
                "minSelect": 0
          },
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_3657182128");
