...
const LESSON_PAGES_TEMPS = {
  fr: [
    ...
    { id: 2, title: 'À — Heure et moment précis', content: `<h3>La préposition <span class="prep">à</span></h3><p>On utilise <strong>à</strong> pour indiquer une <em>heure précise</em> ou un <em>moment fixe</em>.</p><div class="rule-box"><div class="rule-icon">⏰</div><div><strong>Règle :</strong> <em>à</em> + heure précise<br/><strong>Exemples :</strong><ul><li>J'arrive au cinéma <strong>à</strong> 7 heures.</li><li>La réunion commence <strong>à</strong> midi.</li><li>Il se lève <strong>à</strong> 6h30 chaque matin.</li></ul></div></div><div class="info-box">💡 <strong>À retenir :</strong> «à» répond à la question <em>«À quelle heure ?»</em></div>` },
    { id: 3, title: 'En — Mois, saisons et années', content: `<h3>La préposition <span class="prep">en</span></h3><p>On utilise <strong>en</strong> avec les <em>mois</em>, la plupart des <em>saisons</em>, et les <em>années</em>.</p><div class="rule-box"><div class="rule-icon">📅</div><div><strong>Exemples :</strong><ul><li>Marie part en vacances <strong>en</strong> été.</li><li>Les cours commencent <strong>en</strong> septembre.</li><li>J'ai commencé le piano <strong>en</strong> 2015.</li></ul></div></div><div class="compare-box"><div class="compare-item good">✅ <strong>en</strong> été, en automne, en hiver</div><div class="compare-item special">⚠️ <strong>au</strong> printemps (masculin !)</div></div>` },
    { id: 4, title: 'Dans — Durée future', content: `<h3>La préposition <span class="prep">dans</span></h3><p><strong>Dans</strong> exprime un délai ou une durée <em>à venir</em>.</p><div class="rule-box"><div class="rule-icon">🔮</div><div><strong>Exemples :</strong><ul><li>Mon anniversaire est <strong>dans</strong> dix jours.</li><li>Nous arrivons <strong>dans</strong> quinze minutes.</li></ul></div></div><div class="info-box">💡 «dans» répond à <em>«Dans combien de temps ?»</em> — la durée est <strong>future</strong>.</div>` },
    { id: 5, title: 'Depuis — Durée passée jusqu\'à maintenant', content: `<h3>La préposition <span class="prep">depuis</span></h3><p><strong>Depuis</strong> exprime une action qui <em>a commencé dans le passé</em> et qui <em>continue au présent</em>.</p><div class="rule-box"><div class="rule-icon">📆</div><div><strong>Exemples :</strong><ul><li>Pierre travaille ici <strong>depuis</strong> 2018.</li><li><strong>Depuis</strong> deux semaines, je suis malade.</li></ul></div></div><div class="compare-box"><div class="compare-item good">✅ Je travaille ici <strong>depuis</strong> 2018 (encore maintenant)</div><div class="compare-item bad">❌ J'ai travaillé ici <strong>depuis</strong> 2018 (incorrect au passé composé)</div></div>` },
    { id: 6, title: 'Pendant, Avant, Après', content: `<h3><span class="prep">Pendant</span> · <span class="prep">Avant</span> · <span class="prep">Après</span></h3><div class="rule-box"><div class="rule-icon">⌛</div><div><strong>pendant</strong> — durée déterminée<ul><li>Je suis en vacances <strong>pendant</strong> trois semaines.</li></ul></div></div><div class="rule-box"><div class="rule-icon">⬅️</div><div><strong>avant</strong> — antériorité<ul><li>Je me brosse les dents <strong>avant</strong> d'aller dormir.</li></ul></div></div><div class="rule-box"><div class="rule-icon">➡️</div><div><strong>après</strong> — postériorité<ul><li><strong>Après</strong> le petit-déjeuner, je vais au travail.</li></ul></div></div>` },
    { id: 7, title: 'Entre et Vers', content: `<h3><span class="prep">Entre</span> · <span class="prep">Vers</span></h3><div class="rule-box"><div class="rule-icon">↔️</div><div><strong>entre</strong> — intervalle entre deux moments<ul><li>Je vais chez ma mère <strong>entre</strong> 10 heures et midi.</li></ul></div></div><div class="rule-box"><div class="rule-icon">≈</div><div><strong>vers</strong> — approximation temporelle<ul><li>Tu viendras <strong>vers</strong> 5 heures.</li></ul></div></div><div class="info-box">💡 <strong>Vers</strong> exprime une heure <em>approximative</em>.</div>` },
  ...
  en: [
    ...
    { id: 2, title: 'AT — Exact time', content: `<h3>The preposition <span class="prep">at</span></h3><p>We use <strong>at</strong> for a <em>precise time</em> or a <em>fixed moment</em>.</p><div class="rule-box"><div class="rule-icon">⏰</div><div><strong>Rule:</strong> <em>at</em> + exact time<br/><strong>Examples:</strong><ul><li>I arrive at the cinema <strong>at</strong> 7 o'clock.</li><li>The meeting starts <strong>at</strong> noon.</li><li>He wakes up <strong>at</strong> 6:30 every morning.</li></ul></div></div><div class="info-box">💡 <strong>Remember:</strong> «at» answers the question <em>«At what time?»</em></div>` },
    { id: 3, title: 'IN — Month, season and year', content: `<h3>The preposition <span class="prep">in</span></h3><p>We use <strong>in</strong> with <em>months</em>, <em>seasons</em>, <em>years</em>, and for future events (after a delay).</p><div class="rule-box"><div class="rule-icon">📅</div><div><strong>Examples:</strong><ul><li>Marie goes on holiday <strong>in</strong> summer.</li><li>Classes start <strong>in</strong> September.</li><li>I started playing piano <strong>in</strong> 2015.</li><li>My birthday is <strong>in</strong> ten days (future delay).</li></ul></div></div><div class="compare-box"><div class="compare-item good">✅ <strong>in</strong> summer / winter / autumn / spring</div><div class="compare-item good">✅ <strong>in</strong> January · in 2015 · in the morning</div></div>` },
    { id: 4, title: 'ON — Days and dates', content: `<h3>The preposition <span class="prep">on</span></h3><p><strong>On</strong> is used for specific <em>days</em> and <em>dates</em>.</p><div class="rule-box"><div class="rule-icon">📆</div><div><strong>Examples:</strong><ul><li>The meeting is <strong>on</strong> Monday.</li><li>I was born <strong>on</strong> March 5th.</li><li>See you <strong>on</strong> your birthday!</li></ul></div></div><div class="compare-box"><div class="compare-item good">✅ <strong>on</strong> Monday · on March 5th · on Christmas Day</div><div class="compare-item special">⚠️ <strong>at</strong> Christmas (the holiday period) vs <strong>on</strong> Christmas Day</div></div>` },
    { id: 5, title: 'FOR and SINCE — Duration', content: `<h3><span class="prep">For</span> · <span class="prep">Since</span></h3><div class="rule-box"><div class="rule-icon">⌛</div><div><strong>for</strong> — a specific duration (how long?)<ul><li>I am on holiday <strong>for</strong> three weeks.</li><li>She has been learning English <strong>for</strong> two years.</li></ul></div></div><div class="rule-box"><div class="rule-icon">📆</div><div><strong>since</strong> — from a past point until now<ul><li>Pierre has worked here <strong>since</strong> 2018.</li><li><strong>Since</strong> last Monday, I have been sick.</li></ul></div></div><div class="compare-box"><div class="compare-item good">✅ I've lived here <strong>for</strong> 5 years (duration)</div><div class="compare-item good">✅ I've lived here <strong>since</strong> 2019 (start point)</div><div class="compare-item bad">❌ I've lived here <strong>since</strong> 5 years (incorrect!)</div></div>` },
    { id: 6, title: 'BEFORE, AFTER and DURING', content: `<h3><span class="prep">Before</span> · <span class="prep">After</span> · <span class="prep">During</span></h3><div class="rule-box"><div class="rule-icon">⬅️</div><div><strong>before</strong> — earlier than an event<ul><li>I brush my teeth <strong>before</strong> going to sleep.</li></ul></div></div><div class="rule-box"><div class="rule-icon">➡️</div><div><strong>after</strong> — later than an event<ul><li><strong>After</strong> breakfast, I go to work.</li></ul></div></div><div class="rule-box"><div class="rule-icon">↔️</div><div><strong>during</strong> — within a defined period<ul><li><strong>During</strong> the summer, she worked very hard.</li></ul></div></div>` },
    { id: 7, title: 'BY, AGO, BETWEEN and AROUND', content: `<h3><span class="prep">By</span> · <span class="prep">Ago</span> · <span class="prep">Between</span> · <span class="prep">Around</span></h3><div class="rule-box"><div class="rule-icon">⚑</div><div><strong>by</strong> — deadline (no later than)<ul><li>I will finish the project <strong>by</strong> Friday.</li></ul></div></div><div class="rule-box"><div class="rule-icon">⏮️</div><div><strong>ago</strong> — in the past, counting back from now<ul><li>She arrived two years <strong>ago</strong>.</li></ul></div></div><div class="rule-box"><div class="rule-icon">↔️</div><div><strong>between</strong> — interval between two times<ul><li>I visit my mother <strong>between</strong> 10 and noon.</li></ul></div></div><div class="rule-box"><div class="rule-icon">≈</div><div><strong>around</strong> — approximate time<ul><li>You will come <strong>around</strong> 5 o'clock.</li></ul></div></div>` },
...
const LESSON_PAGES_LIEU = {
  fr: [
    ...
    { id: 2, title: 'Dans / En — Intérieur d\'un espace', content: `<h3>Les prépositions <span class="prep">dans</span> et <span class="prep">en</span></h3><p>On utilise <strong>dans</strong> pour indiquer l'intérieur d'un espace délimité.</p><div class="rule-box"><div class="rule-icon">📦</div><div><strong>dans</strong> + article + nom<br/><strong>Exemples :</strong><ul><li>Je mets du café <strong>dans</strong> ma tasse.</li><li>Ma femme fait le repas <strong>dans</strong> la cuisine.</li><li>J'aime lire <strong>dans</strong> l'herbe.</li></ul></div></div><div class="rule-box"><div class="rule-icon">🌍</div><div><strong>en</strong> (sans article) + pays féminin ou continent<br/><strong>Exemples :</strong><ul><li>Je vis <strong>en</strong> France.</li><li>Il voyage <strong>en</strong> Afrique.</li></ul></div></div><div class="info-box">💡 <strong>Dans</strong> = à l'intérieur d'un espace concret. <strong>En</strong> = pour les pays féminins (sans article).</div>` },
    { id: 3, title: 'Sur / Sous — Dessus et dessous', content: `<h3><span class="prep">Sur</span> · <span class="prep">Sous</span></h3><div class="rule-box"><div class="rule-icon">⬆️</div><div><strong>sur</strong> — à la surface de, par-dessus<ul><li>Il y a une peinture <strong>au-dessus du</strong> canapé.</li><li>On peut marcher <strong>autour du</strong> lac.</li></ul></div></div><div class="rule-box"><div class="rule-icon">⬇️</div><div><strong>sous</strong> — en dessous de<ul><li>Le chat se cache <strong>sous</strong> le canapé.</li></ul></div></div><div class="compare-box"><div class="compare-item good">✅ Le livre est <strong>sur</strong> la table (à la surface)</div><div class="compare-item good">✅ Le chat est <strong>sous</strong> la table (en dessous)</div></div>` },
    { id: 4, title: 'Devant / Derrière / À côté de', content: `<h3><span class="prep">Devant</span> · <span class="prep">Derrière</span> · <span class="prep">À côté de</span></h3><div class="rule-box"><div class="rule-icon">➡️</div><div><strong>devant</strong> — en face de, avant<ul><li>Pour lire mon ordinateur, je suis <strong>devant</strong> mon écran.</li></ul></div></div><div class="rule-box"><div class="rule-icon">⬅️</div><div><strong>derrière</strong> — dans le dos de, après<ul><li>Sans ses lunettes, Sonia ne voit pas quand je suis <strong>derrière</strong> elle.</li></ul></div></div><div class="rule-box"><div class="rule-icon">↔️</div><div><strong>à côté de</strong> — à la proximité de<ul><li>3 est <strong>entre</strong> 2 et 4. (entre = au milieu de)</li></ul></div></div>` },
    { id: 5, title: 'Chez — Lieu de vie ou d\'activité', content: `<h3>La préposition <span class="prep">chez</span></h3><p><strong>Chez</strong> s'utilise pour indiquer le domicile ou le lieu habituel d'une personne.</p><div class="rule-box"><div class="rule-icon">🏠</div><div><strong>chez</strong> + personne (nom ou pronom)<br/><strong>Exemples :</strong><ul><li>Après l'école, ma petite sœur va <strong>chez</strong> son amie.</li><li>Quand je vais en vacances, je vis <strong>chez</strong> mon oncle.</li><li>Je mange <strong>au</strong> restaurant (≠ chez → lieu public, pas une personne).</li></ul></div></div><div class="info-box">💡 <strong>Chez</strong> = toujours suivi d'une <em>personne</em> (nom propre, pronom, profession). <br/>Ex : chez le médecin, chez Marie, chez moi.</div>` },
    { id: 6, title: 'À / Au / Aux — Villes, pays et lieux publics', content: `<h3><span class="prep">À</span> · <span class="prep">Au</span> · <span class="prep">Aux</span></h3><div class="rule-box"><div class="rule-icon">🏙️</div><div><strong>à</strong> + ville<ul><li>Toute ma vie, j'ai habité <strong>à</strong> Paris.</li></ul></div></div><div class="rule-box"><div class="rule-icon">🌎</div><div><strong>au</strong> + pays masculin singulier<ul><li>Tu as toujours vécu <strong>au</strong> Mexique ?</li></ul></div></div><div class="rule-box"><div class="rule-icon">🍽️</div><div><strong>au</strong> + lieu public masculin<ul><li>Tous les soirs, je mange <strong>au</strong> restaurant.</li><li>À 8 heures, les enfants vont <strong>à</strong> l'école.</li></ul></div></div><div class="rule-box"><div class="rule-icon">🚽</div><div><strong>aux</strong> + nom pluriel<ul><li>Ma petite sœur doit aller <strong>aux</strong> toilettes.</li></ul></div></div>` },
    { id: 7, title: 'Autour de / Loin de / Au-dessus de', content: `<h3><span class="prep">Autour de</span> · <span class="prep">Loin de</span> · <span class="prep">Au-dessus de</span></h3><div class="rule-box"><div class="rule-icon">⭕</div><div><strong>autour de</strong> — en cercle, tout autour<ul><li>On peut marcher <strong>autour du</strong> lac si tu veux.</li></ul></div></div><div class="rule-box"><div class="rule-icon">↗️</div><div><strong>au-dessus de</strong> — plus haut que<ul><li>Il y a une peinture <strong>au-dessus du</strong> canapé.</li></ul></div></div><div class="rule-box"><div class="rule-icon">📏</div><div><strong>loin de</strong> — à grande distance de<ul><li>Sans ses lunettes, Sonia ne voit pas quand je suis <strong>loin d'elle</strong>.</li></ul></div></div>` },
  ...
  en: [
    ...
    { id: 2, title: 'IN — Inside a space', content: `<h3>The preposition <span class="prep">in</span></h3><p>We use <strong>in</strong> to indicate the <em>interior of a space</em> or a <em>country/city</em>.</p><div class="rule-box"><div class="rule-icon">📦</div><div><strong>in</strong> + enclosed space<br/><strong>Examples:</strong><ul><li>I put coffee <strong>in</strong> my cup.</li><li>My wife cooks <strong>in</strong> the kitchen.</li><li>I like reading <strong>in</strong> the grass.</li></ul></div></div><div class="rule-box"><div class="rule-icon">🌍</div><div><strong>in</strong> + city / country<br/><strong>Examples:</strong><ul><li>All my life, I have lived <strong>in</strong> Paris.</li><li>Have you always lived <strong>in</strong> Mexico?</li></ul></div></div><div class="info-box">💡 <strong>In</strong> = inside a space or geographical location.</div>` },
    { id: 3, title: 'ON / UNDER — Surface and below', content: `<h3><span class="prep">On</span> · <span class="prep">Under</span></h3><div class="rule-box"><div class="rule-icon">⬆️</div><div><strong>on</strong> — on the surface of<ul><li>The book is <strong>on</strong> the table.</li><li>There is a painting <strong>above</strong> the sofa. (au-dessus)</li></ul></div></div><div class="rule-box"><div class="rule-icon">⬇️</div><div><strong>under / below</strong> — beneath<ul><li>The cat hides <strong>under</strong> the sofa.</li></ul></div></div><div class="compare-box"><div class="compare-item good">✅ The book is <strong>on</strong> the table (on the surface)</div><div class="compare-item good">✅ The cat is <strong>under</strong> the table (beneath)</div></div>` },
    { id: 4, title: 'IN FRONT OF / BEHIND / NEXT TO', content: `<h3><span class="prep">In front of</span> · <span class="prep">Behind</span> · <span class="prep">Next to</span></h3><div class="rule-box"><div class="rule-icon">➡️</div><div><strong>in front of</strong> — facing, before<ul><li>To read my screen, I sit <strong>in front of</strong> it.</li></ul></div></div><div class="rule-box"><div class="rule-icon">⬅️</div><div><strong>behind</strong> — at the back of<ul><li>Without her glasses, Sonia can't see when I'm <strong>behind</strong> her.</li></ul></div></div><div class="rule-box"><div class="rule-icon">↔️</div><div><strong>next to / beside</strong> — close to<ul><li>3 is <strong>between</strong> 2 and 4. (between = in the middle of two things)</li></ul></div></div>` },
    { id: 5, title: 'WITH — Someone\'s home', content: `<h3>The preposition <span class="prep">with</span> (and <span class="prep">at</span>)</h3><p>To indicate someone's home, we use <strong>with</strong> + person or <strong>at</strong> + person's.</p><div class="rule-box"><div class="rule-icon">🏠</div><div><strong>with</strong> + person (staying at their home)<br/><strong>Examples:</strong><ul><li>After school, my sister goes to <strong>her friend's</strong> house.</li><li>When I go on holiday, I stay <strong>with</strong> my uncle.</li><li>Every evening, I eat <strong>at</strong> a restaurant (not a person's home).</li></ul></div></div><div class="info-box">💡 In English: "stay <strong>with</strong> someone" (at their home) or "at someone's place".<br/>French equivalent: <em>chez</em></div>` },
    { id: 6, title: 'AT — Specific locations and public places', content: `<h3>The preposition <span class="prep">at</span></h3><p>We use <strong>at</strong> for specific locations, addresses, and public places.</p><div class="rule-box"><div class="rule-icon">🏙️</div><div><strong>at</strong> + specific place<ul><li>I arrive <strong>at</strong> the cinema at 7.</li><li>The children go <strong>to</strong> school at 8. (movement: go to)</li></ul></div></div><div class="rule-box"><div class="rule-icon">🍽️</div><div><strong>at</strong> + place of activity<ul><li>Every evening, I eat <strong>at</strong> a restaurant.</li><li>My sister needs to go <strong>to</strong> the bathroom. (movement)</li></ul></div></div><div class="compare-box"><div class="compare-item good">✅ I am <strong>at</strong> school (location)</div><div class="compare-item good">✅ I go <strong>to</strong> school (movement/direction)</div></div>` },
    { id: 7, title: 'AROUND / ABOVE / FAR FROM', content: `<h3><span class="prep">Around</span> · <span class="prep">Above</span> · <span class="prep">Far from</span></h3><div class="rule-box"><div class="rule-icon">⭕</div><div><strong>around</strong> — in a circle, all around<ul><li>We can walk <strong>around</strong> the lake.</li></ul></div></div><div class="rule-box"><div class="rule-icon">↗️</div><div><strong>above / over</strong> — higher than<ul><li>There is a painting <strong>above</strong> the sofa.</li></ul></div></div><div class="rule-box"><div class="rule-icon">📏</div><div><strong>far from</strong> — at a great distance<ul><li>Without her glasses, Sonia can't see when I'm <strong>far from</strong> her.</li></ul></div></div>` },
